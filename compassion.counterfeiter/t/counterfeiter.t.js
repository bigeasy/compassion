...
function prove (async, assert) {
    ...
    async([function () {
        ...
        destructible.monitor('counterfeiter', Counterfeiter, 8888, '127.0.0.1', async())
    }, function (counterfeiter) {
        async(function () {
            counterfeiter.bootstrap({ republic: 0, conference: conference, id: 'first' }, async())
        }, function () {
            console.log('bootstrapped', !! counterfeiter.events)
            ...
            counterfeiter.join({
                ...
                id: 'second',
                leader: 'first',
                republic: counterfeiter._colleagues['first'].kibitzer.paxos.government.republic
            }, async())
        }, function () {
