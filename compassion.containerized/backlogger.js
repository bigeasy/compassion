    ...
    case 'application/json':
        return cadence(function (async, response) {
            ...
            var loop = async(function () {
                ...
                if (line == null) {
                    events.push({ type: 'body', id: id, body: null })
                    response.end()
                    return [ loop.break ]
                } else {
                    response.write(line)
                    events.push({ type: 'body', id: id, body: JSON.parse(line.toString('utf8')) })
                }
            })()
        })
    case 'application/json':
        return cadence(function (async, response) {
            ...
            var loop = async(function () {
                ...
                if (line == null) {
                    ...
                    events.push({ type: 'body', id: id, body: line.toString('base64') })
                }
            })()
        })
    }
